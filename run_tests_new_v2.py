"""
Run new insurance-causal test files on Databricks serverless compute.

Tests: tests/causal_forest/*, tests/elasticity/*, tests/test_diagnostics_extended.py
"""
...
WORKSPACE_PATH = "/Workspace/insurance-causal"
PROJECT_ROOT = pathlib.Path("/home/ralph/repos/insurance-causal")
...
run = w.jobs.submit(
    run_name="insurance-causal-new-tests-v2",
    tasks=[
        jobs.SubmitTask(
            task_key="run_tests",
